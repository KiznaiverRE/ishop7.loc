...
class ProductController extends AppController
{
    ...
    public function editAction(){
        if (!empty($_POST)){
            ...
            $product->attributes['status'] = $product->attributes['status'] ? 'publish' : 'draft';
        ...
        $related_product = \R::getAll("
                SELECT related_product.related_id, product.title 
...
//            debug($product->attributes['hit'] .'-'. gettype($product->attributes['hit']));
//            die();
