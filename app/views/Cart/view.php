            ...
            <div class="col-md-12">
                <div class="product-one cart">
                    ...
                    <?php if(!empty($_SESSION['cart'])):?>
                        <div class="table-responsive">
                            <table class="table table-hover table-striped cart-table">
                                ...
                                <?php foreach($_SESSION['cart'] as $id => $item): ?>
                                    <tr>
                                        <td><a class="cart-table-link" href="product/<?=$item['alias'] ?>"><img class="cart-table-img" src="images/<?= $item['img'] ?>" alt="<?=$item['title'] ?>"></a></td>
                        ...
                        <div class="col-md-6">
                            <form method="post" id="checkout-form" action="cart/checkout" role="form" data-toggle="validator">
