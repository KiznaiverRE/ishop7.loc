                ...
                <form action="<?= ADMIN ?>/currency/add" method="POST" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <span style="font-size: 13px; color: grey">Если это валюта является базовой, надо поставить значение 1</span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="base">Базовая валюта</label>
                            <input type="checkbox" name="base" id="base" placeholder="Базовая валюта"">
                        </div>
                    </div>
