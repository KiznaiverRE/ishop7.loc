                    ...
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input
                                type="text"
                                name="title"
                                value="<?= isset($_SESSION['form_data']['title']) ? hchrs($_SESSION['form_data']['title']) : null?>"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="text"
                                name="keywords"
                                value="<?= isset($_SESSION['form_data']['keywords']) ? hchrs($_SESSION['form_data']['keywords']) : null?>"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="text"
                                name="description"
                                value="<?= isset($_SESSION['form_data']['description']) ? hchrs($_SESSION['form_data']['description']) : null?>"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="<?= isset($_SESSION['form_data']['price']) ? hchrs($_SESSION['form_data']['price']) : 0?>"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="<?= isset($_SESSION['form_data']['old_price']) ? hchrs($_SESSION['form_data']['old_price']) : 0?>"
