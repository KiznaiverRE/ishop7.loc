...
<section class="content-header">
    <h1>
        ...
        <?php if ($order['status'] == 'open'): ?>
            <a href="<?=ADMIN ?>/order/change?id=<?=$order['id']?>&status=closed" class="btn btn-success btn-xs">Одобрить</a>
        <?php else: ?>
            <a href="<?=ADMIN ?>/order/change?id=<?=$order['id']?>&status=open" class="btn btn-default btn-xs">Вернуть на доработку</a>
        <?php endif; ?>
