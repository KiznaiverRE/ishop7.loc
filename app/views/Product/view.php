...
<!--                            --><?php //debug($_SESSION['cart'][2]['qty']); ?>
                            ...
                            <?php if ($product->old_price): ?>
                                <del id="old-price" data-oldBase="<?= $product->old_price * $curr['value'] ?>"> <?= $curr['symbol_left'] ?> <?=$product->old_price  * $curr['value']?> <?= $curr['symbol_right'] ?></del>
                            <?php endif; ?>
                            <p><?= $product->content ?></p>
                            <?php if($mods): ?>
                                <div class="available">
                                    ...
                                    <li class="d-flex align-items-center">
                                        ...
                                        <select>
                                            ...
                                            <?php foreach ($mods as $mod): ?>
                                                <option value="<?=$mod->id?>" data-title="<?=$mod->title?>" data-price="<?=$mod->price * $curr['value'];?>" data-oldprice="<?=$mod->old_price * $curr['value'];?>"><?=$mod->title?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </li>
...
<!--                                    </li>-->
                            ...
                            <div class="d-flex">
                                <div class="quantity mt-2 mr-2 w-25">
                                    <input type="number" value="1" name="quantity" min="1" step="1" class="input-group-text w-100 h-100">
                                </div>
                                <a id="productAdd" data-id="<?=$product->id?>" href="cart/add?id=<?=$product->id?>" class="add-cart item_add add-to-cart-link mt-2">ADD TO CART</a>
                            </div>
