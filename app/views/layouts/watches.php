                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <?php if (!empty($_SESSION['user'])): ?>
                                <li><a href="#">Добро пожаловать, <?= hchrs($_SESSION['user']['name']) ?></a></li>
        ...
        <div class="header">
            <div class="col-md-9 header-left">
                <div class="menu-container">
                    <div class="menu">
                        <?php new \app\widgets\menu\Menu([ // Здесь и передаём настройки
                            'tpl' => WWW . '/menu/menu.php', // Например ВИД виджета меню
                            'container' => 'ul',
            ...
            <div class="col-md-3 header-right">
                <div class="search-bar">
                    <form action="search" method="get" autocomplete="off">
                        <input required type="text" id="typeahead" class="typeahead" name="s">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="cart/view" type="button" class="btn btn-primary checkout-btn">Оформить заказ</a>
                <button type="button" class="btn btn-danger clear-cart-btn" onclick="clearCart()">Очистить корзину</button>
            </div>
        </div>
    </div>
</div>
